...
class ErrorCode(StrEnum):
    ...
    RECONNECT_TOKEN_EXPIRED = "RECONNECT_TOKEN_EXPIRED"  # 房间重连凭证失效 → 401
    ...
    HOST_MODEL_UNAVAILABLE = "HOST_MODEL_UNAVAILABLE"
    ...
    TURN_RESUME_UNAVAILABLE = "TURN_RESUME_UNAVAILABLE"
